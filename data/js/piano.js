...
(function() {
    ...
    function buildPiano() {
        ...
        function addKey(i) {
            ...
            dataURI = null;
            function play(evt) {
				var played_notes = $("#played_notes").val();
				played_notes = played_notes + notes_notes[i+12];
				played_notes = played_notes.slice(played_notes.length - 50);
				$("#played_notes").val(played_notes);
				notes_played(played_notes);
                // sound
